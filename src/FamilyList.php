...
$sPageTitle = gettext("Lista de Familias");
require "Include/Header.php";

?>

<div class="pull-right">
    <a class="btn btn-success" role="button" href="FamilyEditor.php"> <span class="fa fa-plus" aria-hidden="true"></span> Añadir Familia</a>
</div>
<p><br/><br/></p>
<div class="box">

...
$sPageTitle = gettext("Calendario de Eventos");
...
<script src="<?= $sRootPath ?>/skin/adminlte/plugins/fullcalendar/gcal.js"></script>
<script>
  $(function () {
    /* initialize the calendar
     -----------------------------------------------------------------*/
    $('#calendar').fullCalendar({
      googleCalendarApiKey: 'AIzaSyBilFx0sFBb8_gYh0N-r2tW826P-cdVdrU',
      header: {

...
if ($iUserID > 0)
{
    ...
    {
        $sErrorText = gettext('Muchos intentos fallidos: su cuenta ha sido bloqueada.  Por favor contacte al administrador.');
    }
    ...
    elseif ($usr_Password != $sPasswordHashSha256)
    {
        ...
        // Set the error text
        $sErrorText = gettext('Usuario o contraseña inválidos');
    }
    else
    {
...
$sPageTitle = "ChurchCRM - Ingresar";
require ("Include/HeaderNotLoggedIn.php");
?>

<!-- Versiones: Aser, Benjamin, Dan, Efraín, Gad, Isacar, Judá, Leví, Manasés, Neftalí, Rubén, Simeón, Zabulón -->
<div class="login-box">
    <div class="login-logo">
        <b>ICM</b>anager</a><br>
        <h4><i>Versión 1.0 - Aser</i></h4>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg"><?= gettext('Por favor inicie sesión') ?></p>

<?php
if (isset($_GET['Timeout']))
    $loginPageMsg = "Su sesión anterior expiró.  Por favor ingrese nuevamente.";
...
<form class="form-signin" role="form" method="post" name="LoginForm" action="Login.php">
    <div class="form-group has-feedback">
        <input type="text" id="UserBox" name="User" class="form-control" placeholder="Email/Usuario" required autofocus>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
    </div>
    <div class="form-group has-feedback">
        <input type="password" id="PasswordBox" name="Password" class="form-control" placeholder="Contraseña" required autofocus>
    ...
    <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat"><?= gettext('Iniciar') ?></button>
        </div>
    </div>
</form>
<?php
...
<div id="not-chrome" class="error-page">
  <div class="callout callout-warning">
    <h4>Para una mejor experiencia, por favor utilice Google Chrome.</h4>
    <p>Este software ha sido probado para Google Chrome... <a href="https://www.google.com/chrome/browser/desktop/"> Descargar e instalar Google Chrome</a></p>
  </div>
</div>

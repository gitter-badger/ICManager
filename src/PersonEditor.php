...
//Set the page title
$sPageTitle = gettext("Editor de Persona");
...
<form method="post" action="PersonEditor.php?PersonID=<?= $iPersonID ?>" name="PersonEditor" >
	<div class="alert alert-info alert-dismissable">
		...
		<strong><span style="color: red;"><?= gettext("Texto en Rojo") ?></span></strong> <?php echo gettext("indica detalles asociados al regristro familiar.");?>
	</div>
	<?php if ( $bErrorFlag ) { ?>
	...
	<div class="box box-solid box-primary">
		<div class="box-header">
			<h3 class="box-title"><?= gettext("Información Personal") ?></h3>
			<div class="pull-right">
				<input type="submit" class="btn btn-default" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
			</div>
		</div><!-- /.box-header -->
		<div class="box-body">
			<div class="form-group">
				<div class="row">
					<div class="col-md-2">
						<label><?= gettext("Sexo:") ?></label>
						<select name="Gender" class="form-control">
							<option value="0"><?= gettext("Seleccione Sexo") ?></option>
							<option value="0" disabled>-----------------------</option>
							<option value="1" <?php if ($iGender == 1) { echo "selected"; } ?>><?= gettext("Masculino") ?></option>
							<option value="2" <?php if ($iGender == 2) { echo "selected"; } ?>><?= gettext("Femenino") ?></option>
						</select>
					</div>
					<div class="col-md-3">
						<label for="Title"><?= gettext("Tratamiento:") ?></label>
						<input type="text" name="Title" id="Title" value="<?= htmlentities(stripslashes($sTitle),ENT_NOQUOTES, "UTF-8") ?>" class="form-control" placeholder="<?= gettext("Dn, Dña, Sr, Sra, Dr, Lic, Rev.") ?>">
					</div>
				</div>
				<p/>
				<div class="row">
					<div class="col-md-4">
						<label for="FirstName"><?= gettext("Primer Nombre:") ?></label>
					...
					<div class="col-md-2">
						<label for="MiddleName"><?= gettext("Segundo Nombre:") ?></label>
					...
					<div class="col-md-4">
						<label for="LastName"><?= gettext("Apellido(s):") ?></label>
					...
					<div class="col-md-1">
						<label for="Suffix"><?= gettext("Sufijo:") ?></label>
						<input type="text" name="Suffix" id="Suffix" value="<?= htmlentities(stripslashes($sSuffix),ENT_NOQUOTES, "UTF-8") ?>" placeholder="<?= gettext("Hj, III") ?>" class="form-control">
					</div>
				</div>
				<p/>
				<div class="row">
					<div class="col-md-2">
						<label><?= gettext("Mes Nacimiento:") ?></label>
						<select name="BirthMonth" class="form-control">
							<option value="0" <?php if ($iBirthMonth == 0) { echo "selected"; } ?>><?= gettext("Seleccione Mes") ?></option>
							<option value="01" <?php if ($iBirthMonth == 1) { echo "selected"; } ?>><?= gettext("Enero") ?></option>
							<option value="02" <?php if ($iBirthMonth == 2) { echo "selected"; } ?>><?= gettext("Febrero") ?></option>
							<option value="03" <?php if ($iBirthMonth == 3) { echo "selected"; } ?>><?= gettext("Marzo") ?></option>
							<option value="04" <?php if ($iBirthMonth == 4) { echo "selected"; } ?>><?= gettext("Abril") ?></option>
							<option value="05" <?php if ($iBirthMonth == 5) { echo "selected"; } ?>><?= gettext("Mayo") ?></option>
							<option value="06" <?php if ($iBirthMonth == 6) { echo "selected"; } ?>><?= gettext("Junio") ?></option>
							<option value="07" <?php if ($iBirthMonth == 7) { echo "selected"; } ?>><?= gettext("Julio") ?></option>
							<option value="08" <?php if ($iBirthMonth == 8) { echo "selected"; } ?>><?= gettext("Agosto") ?></option>
							<option value="09" <?php if ($iBirthMonth == 9) { echo "selected"; } ?>><?= gettext("Septiembre") ?></option>
							<option value="10" <?php if ($iBirthMonth == 10) { echo "selected"; } ?>><?= gettext("Octubre") ?></option>
							<option value="11" <?php if ($iBirthMonth == 11) { echo "selected"; } ?>><?= gettext("Noviembre") ?></option>
							<option value="12" <?php if ($iBirthMonth == 12) { echo "selected"; } ?>><?= gettext("Diciembre") ?></option>
						</select>
					</div>
					<div class="col-md-2">
						<label><?= gettext("Día Nacimiento:") ?></label>
						<select name="BirthDay" class="form-control">
							<option value="0"><?= gettext("Seleccione Día") ?></option>
							<?php for ($x=1; $x < 32; $x++) {
					...
					<div class="col-md-2">
						<label><?= gettext("Año Nacimiento:") ?></label>
					...
					<div class="col-md-2">
						<label><?= gettext("Ocultar Edad") ?></label><br/>
	...
	<div class="box box-solid box-primary">
		<div class="box-header">
			<h3 class="box-title"><?= gettext("Información de Familia") ?></h3>
			<div class="pull-right">
				<input type="submit" class="btn btn-default" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
			</div>
		</div><!-- /.box-header -->
		<div class="box-body">
			<div class="form-group col-md-3">
				<label><?= gettext("Rol Familiar:") ?></label>
				<select name="FamilyRole" class="form-control">
					<option value="0"><?= gettext("Sin Asignar") ?></option>
					<option value="0" disabled>-----------------------</option>
			...
			<div class="form-group col-md-6">
				<label><?= gettext("Familia:");  ?></label>
				<select name="Family" size="8" class="form-control">
					<option value="0" selected><?= gettext("Sin Asignar") ?></option>
					<option value="-1"><?= gettext("Crear Nueva Familia (Usando Apellido)") ?></option>
					<option value="0" disabled>-----------------------</option>
	...
	<div class="box box-solid box-primary">
		<div class="box-header">
			<h3 class="box-title"><?= gettext("Información de Contacto") ?></h3>
			<div class="pull-right">
				<input type="submit" class="btn btn-default" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
			</div>
		</div><!-- /.box-header -->
				...
				<div class="form-group">
					<div class="col-md-6">
						<label>
							...
							echo gettext("Dirección (Calle #Núm):");
					...
					<div class="col-md-3">
						<label>
							...
							echo gettext("Dirección (Bloque, Depto, Letra):");
			...
			<div class="row">
				<div class="form-group col-md-3">
					<label for="HomePhone">
						<?php
						if ($bFamilyHomePhone)
							echo "<span style=\"color: red;\">". gettext("Teléfono Casa:") ."</span>";
						else
							echo gettext("Teléfono Casa:");
						?>
					</label>
					<div class="input-group">
						...
						<input type="text" name="HomePhone" value="<?= htmlentities(stripslashes($sHomePhone),ENT_NOQUOTES, "UTF-8") ?>" size="30" maxlength="30" class="form-control" data-inputmask='"mask": "(+56) 9 9999 9999"' data-mask>
				...
				<div class="form-group col-md-3">
					...
					<?php
					if ($bFamilyWorkPhone)
						echo "<span style=\"color: red;\">" . gettext("Teléfono Trabajo:") . "</span>";
					else
						echo gettext("Teléfono Trabajo:");
					?>
					</label>
					<div class="input-group">
						<div class="input-group-addon">
						...
						<input type="text" name="WorkPhone" value="<?= htmlentities(stripslashes($sWorkPhone),ENT_NOQUOTES, "UTF-8") ?>" size="30" maxlength="30" class="form-control" data-inputmask='"mask": "(+56) 9 9999 9999"' data-mask/>
				...
				<div class="form-group col-md-3">
					<label for="CellPhone">
						<?php
						if ($bFamilyCellPhone)
							echo "<span style=\"color: red;\">" . gettext("Teléfono Móvil:") . "</span>";
						else
							echo gettext("Teléfono Móvil:");
						?>
					</label>
					<div class="input-group">
						<div class="input-group-addon">
						...
						<input type="text" name="CellPhone" value="<?= htmlentities(stripslashes($sCellPhone),ENT_NOQUOTES, "UTF-8") ?>" size="30" maxlength="30" class="form-control" data-inputmask='"mask": "(+56) 9 9999 9999"' data-mask>
			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="Email">
						<?php
							if ($bFamilyEmail)
								echo "<span style=\"color: red;\">" . gettext("Correo Electrónico:") . "</span></td>";
							else
								echo gettext("Correo Electrónico:") . "</td>";
						?>
					</label>
					<div class="input-group">
						<div class="input-group-addon">
				...
				<div class="form-group col-md-4">
					<label for="WorkEmail"><?= gettext("Trabajo / Otro:") ?></label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-envelope"></i>
						</div>
	...
	<div class="box box-solid box-primary">
		<div class="box-header">
			<h3 class="box-title"><?= gettext("Información de Membresía") ?></h3>
			<div class="pull-right">
				<input type="submit" class="btn btn-default" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
			</div>
		</div><!-- /.box-header -->
		<div class="box-body">
			<div class="row">
				...
				<div class="form-group col-md-4">
					<label><?= gettext("Fecha Primera Visita:") ?></label>
					<div class="input-group">
						<div class="input-group-addon">
				...
				<?php } ?>
				<div class="form-group col-md-4">
					<label><?= gettext("Fecha Membresía:") ?></label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-calendar"></i>
						</div>
			...
			<div class="form-group col-md-4">
				<label><?= gettext("Clasificación:") ?></label>
	...
	<div class="box box-solid box-primary">
		<div class="box-header">
			<h3 class="box-title"><?= gettext("Campos Personalizados") ?></h3>
			<div class="pull-right">
				<input type="submit" class="btn btn-default" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
			</div>
		</div><!-- /.box-header -->
	...
	<input type="submit" class="btn btn-primary" value="<?= gettext("Guardar") ?>" name="PersonSubmit">
	<?php if ($_SESSION['bAddRecords']) { echo "<input type=\"submit\" class=\"btn btn-primary\" value=\"" . gettext("Guardar y Añadir") . "\" name=\"PersonSubmitAndAdd\">"; } ?>

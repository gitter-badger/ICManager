...
// Set the page title
$sPageTitle = gettext("Bienvenido a ChurchCRM");
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            ...
            <a href="<?= $sRootPath ?>/FamilyList.php" class="small-box-footer">
                <?= gettext("Ver Todas las Familias") ?> <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="<?= $sRootPath ?>/SelectList.php?mode=person" class="small-box-footer">
                <?= gettext("Ver Todas las Personas") ?> <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
            ...
            <a href="<?= $sRootPath ?>/sundayschool/SundaySchoolDashboard.php" class="small-box-footer">
                <?= gettext("Más Info") ?> <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
    ...
    <div class="col-lg-6">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <h3 class="box-title"><?= gettext("Últimas Familias") ?></h3>
            </div><!-- /.box-header -->
            <div class="box-body clearfix">
                <div class="table-responsive">
                    <table class="table table-striped table-condensed">
                        <thead>
                        <tr>
                            <th data-field="name"><?= gettext("Nombre Familia") ?></th>
                            <th data-field="address"><?= gettext("Dirección") ?></th>
                            <th data-field="city"><?= gettext("Creada") ?></th>
                        </tr>
                        </thead>
                        <tbody>
    ...
    <div class="col-lg-6">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <h3 class="box-title"><?= gettext("Familias Actualizadas") ?></h3>
            </div><!-- /.box-header -->
            <div class="box-body clearfix">
                <div class="table-responsive">
                    <table class="table table-striped table-condensed">
                        ...
                        <tr>
                            <th data-field="name"><?= gettext("Nombre Familia") ?></th>
                            <th data-field="address"><?= gettext("Dirección") ?></th>
                            <th data-field="city"><?= gettext("Actualizada") ?></th>
                        </tr>
                        </thead>
                        <tbody>
...
<div class="row">
        ...
        <div class="box box-solid">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= gettext("Últimos Miembros") ?></h3>
                    <div class="box-tools pull-right">
    ...
    <div class="col-lg-6">
        <div class="box box-solid">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= gettext("Miembros Actualizados") ?></h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>

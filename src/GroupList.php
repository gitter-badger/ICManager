...
//Set the page title
$sPageTitle = gettext('Listado de Grupos');
...
<form action="#" method="get" class="form">
    <label for="addNewGruop"><?= gettext("Añadir Nuevo Grupo: ") ?></label>
    <input class="form-control newGroup" name="groupName" id="groupName" style="width:100%">
    <br>
    <button type="button" class="btn btn-primary" id="addNewGroup">Añadir Nuevo Grupo</button>
</form>
<?php
}
?>

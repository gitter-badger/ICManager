...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Funciones Miembros</h3>
  </div>
  <div class="box-body">
    <a href="SelectList.php?mode=person" class="btn btn-app"><i class="fa fa-user"></i><?= gettext("Todas las Personas") ?></a>
    <a href="OptionManager.php?mode=classes" class="btn btn-app"><i
        class="fa fa-gears"></i><?= gettext("Administrador de Clasificaciones") ?></a>
    <?php
    if ($sEmailLink)
    {
      ...
      // Display link
       ?>
        <div class="btn-group">
          <a  class="btn btn-app" href="mailto:<?= mb_substr($sEmailLink,0,-3) ?>"><i class="fa fa-send-o"></i><?= gettext('Email a Todos')?></a>
       ...
       <div class="btn-group">
          <a class="btn btn-app" href="mailto:?bcc=<?= mb_substr($sEmailLink,0,-3) ?>"><i class="fa fa-send"></i><?=gettext('Email a Todos (CCO)') ?></a>
           <button type="button" class="btn btn-app dropdown-toggle" data-toggle="dropdown" >
            <span class="caret"></span>
            <span class="sr-only">Toggle Dropdown</span>
          </button>
     ...
     ?>
    <br/>
    <a href="FamilyList.php" class="btn btn-app"><i class="fa fa-users"></i><?= gettext("Todas las Familias") ?></a>
    <a href="OptionManager.php?mode=famroles" class="btn btn-app"><i
        class="fa fa-cubes"></i><?= gettext("Roles Familia") ?></a>
    <a href="GeoPage.php" class="btn btn-app"><i class="fa fa-globe"></i><?= gettext("Geografía Familia") ?></a>
    <a href="MapUsingGoogle.php?GroupID=-1" class="btn btn-app"><i class="fa fa-map"></i><?= gettext("Mapa de Familias") ?>
    </a>
    <a href="UpdateAllLatLon.php" class="btn btn-app"><i
        class="fa fa-map-pin"></i><?= gettext("Actualizar Todas las Coordenadas de Familia") ?></a>
    <?php if ($_SESSION['bAdmin']) { ?>
      <br/>
      <a href="VolunteerOpportunityEditor.php" class="btn btn-app"><i
          class="fa fa-bullhorn"></i><?= gettext("Oportunidades de Servicio") ?></a>
      <a href="PersonCustomFieldsEditor.php" class="btn btn-app"><i
          class="fa fa-gear"></i><?= gettext("Campos Personalizados Persona") ?></a>
      <a href="FamilyCustomFieldsEditor.php" class="btn btn-app"><i
          class="fa fa-gear"></i><?= gettext("Campos Personalizados Familia") ?></a>
    <?php } ?>
  ...
  <div class="col-lg-3">
    ...
    <div class="small-box bg-aqua">
      ...
      <a href="<?= $sRootPath . "/" ?>FamilyList.php" class="small-box-footer">
        Ver Todas las Familias <i class="fa fa-arrow-circle-right"></i>
      </a>
    </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3">
    ...
    <div class="small-box bg-green">
      ...
      <a href="<?= $sRootPath . "/" ?>SelectList.php?mode=person" class="small-box-footer">
        Ver Todas las Personas <i class="fa fa-arrow-circle-right"></i>
      </a>
    </div>
  </div>
  <!-- ./col -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="box box-info">
      ...
      <div class="box-body">
        <a class="MediumText" href="GroupReports.php"><?php echo gettext('Reportes de grupos y roles'); ?></a>
        <br>
        ...
        <?php if ($bCreateDirectory) {
          ...
          <p><a class="MediumText"
                href="DirectoryReports.php"><?= gettext('Directorio de Miembros') ?></a><br><?= gettext('Directorio imprimible de todos los miembros, por familia.') ?>
          </p>
        <?php } ?>
  ...
  <div class="col-lg-6">
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Roles de Familia</h3>
  ...
  <div class="col-lg-6">
    <div class="box box-primary">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Clasificación de Personas</h3>
    ...
    <div class="box box-info">
      <div class="box-header">
        ...
        <h3 class="box-title">Demografía de Sexo</h3>
